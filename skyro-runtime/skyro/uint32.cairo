...
# Some constants
const BIT_LENGTH = 32  # I'm aiming for the rest of the file to be parametric over values for BIT_LENGTH up to 64, if possible
const SHIFT = 2 ** 32  # mjg can we eliminate this duplication?
