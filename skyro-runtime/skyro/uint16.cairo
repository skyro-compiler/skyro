...
# Some constants
const BIT_LENGTH = 16  # I'm aiming for the rest of the file to be parametric over values for BIT_LENGTH up to 64, if possible
const SHIFT = 2 ** 16  # mjg can we eliminate this duplication?
