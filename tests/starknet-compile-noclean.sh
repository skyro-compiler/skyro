...
timeout $TIMEOUT ../../../../build/exec/idrisToCairo --no-color --directive starknet --no-prelude -p cairolib --cg cairo $FILE_NAME.idr -o $FILE_NAME.cairo_unformatted || IDRIS_COMPILE_ERR=$?
